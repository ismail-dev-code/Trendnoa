    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-slate-400">
              Your Style, Your Story. Discover fashion that defines you — from timeless classics to the latest trends, Trendnoa brings style to your doorstep.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 mt-8 pt-4 text-center text-xs text-slate-500">
          ...
          <span className="text-sky-300">Trend</span>
          <span className="text-amber-400">noa</span>. All rights reserved.
        </div>
      </div>
    </footer>
  );
